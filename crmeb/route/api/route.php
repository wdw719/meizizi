...
Route::group(function () {
    ...
    /**************************/
    //美滋滋新添加方法
    Route::post('goods/help', 'goods.GoodsController/help')->name('goodsHelp'); //帮助中心
    Route::post('goods/helpInfo', 'goods.GoodsController/helpInfo')->name('goodsHelpInfo'); //帮助中心详情
    Route::post('index/register', 'goods.IndexController/register')->name('indexRegister'); //用户注册
    Route::post('upload/image', 'PublicController/upload_image')->name('uploadImage');//图片上传
    Route::post('index/login', 'goods.IndexController/login')->name('indexLogin');//登陆
    Route::post('index/editUserData', 'goods.IndexController/editUserData')->name('indexEditUserData');//修改用户资料
    Route::post('index/userInfo', 'goods.IndexController/userInfo')->name('indexUserInfo');//用户资料信息
    Route::post('index/edition', 'goods.IndexController/edition')->name('indexEdition');//版本升级
    Route::post('index/setUpPassword', 'goods.IndexController/setUpPassword')->name('indexSetUpPassword');//设置密码
    Route::post('index/editPassword', 'goods.IndexController/editPassword')->name('indexEditPassword');//修改密码
    Route::post('goods/userAddSearch', 'goods.GoodsController/userAddSearch')->name('goodsUserAddSearch');//用户搜索记录
    Route::post('goods/userDelSearch', 'goods.GoodsController/userDelSearch')->name('goodsUserDelSearch');//用户清空历史记录
    Route::post('index/brandList', 'goods.IndexController/brandList')->name('indexBrandList');//品牌列表
    Route::post('goods/goodsList', 'goods.GoodsController/goodsList')->name('goodsGoodsList');//产品列表
